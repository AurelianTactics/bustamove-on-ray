...
run_experiments({
    'bustamove-ppo': {
        ...
        'config': {
            'horizon':grid_search([256,1024,2048]),#grid_search([256,512,1024,2048]),
            # grid search over learning rate
            'sgd_stepsize': grid_search([1e-3, 1e-4, 1e-5]),#grid_search([5e-4, 1e-4, 5e-5, 1e-5]),
            'timesteps_per_batch': grid_search([32,64,128]),#grid_search([16,32,64,128]),#40000,
            ...
            'entropy_coeff':grid_search([0.0,0.1]),#grid_search([0.0,0.05,0.1]),
